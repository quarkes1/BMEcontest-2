...
**当前最优（滑窗管线 v4.2，全局官方口径 5 折均值）**：

| fold | F1 | sens | ppv | TP/eligible |
|---|---|---|---|---|
| 0 | 0.512 | 0.478 | 0.550 | 11/23 |
| 1 | **0.767** | 0.742 | 0.793 | 23/31 |
| 2 | 0.508 | 0.556 | 0.469 | 15/27 |
| 3 | 0.540 | 0.531 | 0.548 | 17/32 |
| 4 | 0.649 | 0.600 | 0.706 | 24/40 |
| **均值** | **~0.595** | | | |
| 全局聚合 | **0.592** | 0.588 | 0.596 | 90/153 |
